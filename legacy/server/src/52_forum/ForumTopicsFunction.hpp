...
//////////////////////////////////////////////////////////////////////////////////////////
/// ForumTopicsFunction class header.
///	@file ForumTopicsFunction.hpp
...
#ifndef SYNTHESE_ForumTopicsFunction_H__
#define SYNTHESE_ForumTopicsFunction_H__
...
namespace synthese
{
	...
	{
		//////////////////////////////////////////////////////////////////////////
		///	52.15 Function : ForumTopicsFunction.
		...
		/// Parameters :
		///	<ul>
		///		<li>node_id : id of the node of the topics</li>
		///		<li>node_extension : node extension key</li>
		///		<li>page : id of the display template to use for the display of each topic (the display
		///			is done by ForumInterfacePage::DisplayTopic)</li>
		...
		///		<li>sort : sort by date ascendantly</li>
		///	</ul>
		class ForumTopicsFunction:
			public util::FactorableTemplate<server::Function,ForumTopicsFunction>
		{
		public:
...
#endif // SYNTHESE_ForumTopicsFunction_H__
