...
//	BOOST_CHECK_THROW(node1.getNextSibling(), InconsistentTreeException);
	...
	BOOST_CHECK_EQUAL(node1.getRank(), 0UL);
	BOOST_CHECK_EQUAL(node1.getDepth(), 1ULL);
	...
	BOOST_REQUIRE_EQUAL(root.getChildren().size(), 1ULL);
	BOOST_CHECK_EQUAL(root.getChildren().begin()->second, &node1);
	BOOST_REQUIRE_EQUAL(node1.getChildren().size(), 1ULL);
	...
	BOOST_CHECK_EQUAL(node2.getRank(), 0UL);
	BOOST_CHECK_EQUAL(node2.getDepth(), 2ULL);
	...
	BOOST_REQUIRE_EQUAL(root.getChildren().size(), 1ULL);
	BOOST_CHECK_EQUAL(root.getChildren().begin()->second, &node1);
	BOOST_REQUIRE_EQUAL(node1.getChildren().size(), 2ULL);
	...
	BOOST_CHECK_EQUAL(node3.getRank(), 1UL);
	BOOST_CHECK_EQUAL(node3.getDepth(), 2ULL);
	BOOST_CHECK(node3.getPreviousSibling() == &node2);
	BOOST_CHECK(node3.getNextSibling() == NULL);

	TN node4;
	node4.setRoot(&root);
	BOOST_CHECK_EQUAL(root.getChildren().size(), 1ULL);
	...
	BOOST_REQUIRE_EQUAL(root.getChildren().size(), 2ULL);
