...
if(WIN32)
   ...
   ELSE()
      find_path(PNG_INCLUDE_DIR NAMES png.h PATHS /opt/rcs/png/include /usr/local/include /usr/include)
      find_library(PNG_LIBRARY NAMES png PATHS /opt/rcs/png/lib /usr/local/lib /usr/lib)
   ENDIF()
