...
if(WIN32)
   ...
   ELSE()
      find_path(GEOSC_INCLUDE_DIR NAMES geos_c.h PATHS /opt/rcs/geos/capi /usr/local/include /usr/include)
      find_library(GEOSC_LIBRARY NAMES geosc PATHS /opt/rcs/geos/lib /usr/local/lib /usr/lib)
   ENDIF()
