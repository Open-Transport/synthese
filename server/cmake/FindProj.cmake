...
if(WIN32)
   ...
   ELSE()
      find_path(PROJ_INCLUDE_DIR NAMES proj_api.h PATHS /opt/rcs/proj/include /usr/local/include /usr/include)
      find_library(PROJ_LIBRARY NAMES proj PATHS /opt/rcs/proj/lib /usr/local/lib /usr/lib)
   ENDIF()
