////////////////////////////////////////////////////////////////////////////////
/// UpdateDisplayMaintenanceAction class header.
///	@file UpdateDisplayMaintenanceAction.h
///	@author Hugues Romain
///	@date 2008-12-19 3:16
///
...
#ifndef SYNTHESE_UpdateDisplayMaintenanceAction_H__
#define SYNTHESE_UpdateDisplayMaintenanceAction_H__
...
namespace synthese
{
	namespace departure_boards
	{
		...
		////////////////////////////////////////////////////////////////////
		/// Display maintenance update action class.
		///	@ingroup m54Actions refActions
		/// Writes : DisplayScreenTableSync
		///	Logs to : DisplayMaintenanceLog
		////////////////////////////////////////////////////////////////////
		...
		public:
			...
			static const std::string PARAMETER_ONLINE;
		...
		public:
			...
			////////////////////////////////////////////////////////////////////
			///	Screen setter.
			///	@param id ID of the screen to update
			///	@author Hugues Romain
			///	@date 2008
			////////////////////////////////////////////////////////////////////
