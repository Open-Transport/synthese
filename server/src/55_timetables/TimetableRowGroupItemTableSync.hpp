...
#ifndef SYNTHESE_TimetableRowGroupItemTableSync_H__
#define SYNTHESE_TimetableRowGroupItemTableSync_H__
	...
	namespace timetables
	{
		...
		public:
			...
			static SearchResult Search(
				util::Env& env,
				boost::optional<util::RegistryKeyType> timetableRowGroupId = boost::optional<util::RegistryKeyType>(),
