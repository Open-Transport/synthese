...
/** TimetableRight class header.
	@file TimetableRight.h
...
#ifndef SYNTHESE_timetables_TimetableRight_H__
#define SYNTHESE_timetables_TimetableRight_H__
...
namespace synthese
{
	...
	{
		/** TimetableRight Right Class.
			@ingroup m55Rights refRights
...
#endif // SYNTHESE_timetables_TimetableRight_H__
