...
/** RoadJourneyPlannerResult class header.
	@file RoadJourneyPlannerResult.h
...
#ifndef SYNTHESE_routeplanner_RoadRoutePlannerResult_h__
#define SYNTHESE_routeplanner_RoadRoutePlannerResult_h__
...
namespace synthese
{
	...
	{
		/** Road journey planner result class.
			@ingroup m59
		*/
		class RoadJourneyPlannerResult
		{
		public:

			typedef algorithm::TimeSlotRoutePlanner::Result Journeys;

			RoadJourneyPlannerResult(
