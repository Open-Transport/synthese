...
//////////////////////////////////////////////////////////////////////////
///	DriverActivityAdmin class header.
///	@file DriverActivityAdmin.hpp
...
#ifndef SYNTHESE_DriverActivityAdmin_H__
#define SYNTHESE_DriverActivityAdmin_H__
...
namespace synthese
{
	namespace pt_operation
	{
		...
		//////////////////////////////////////////////////////////////////////////
		/// DriverActivityAdmin Admin compound class.
		///	@ingroup m37Admin refAdmin
		///	@author Hugues Romain
		///	@date 2012
		class DriverActivityAdmin:
			public admin::AdminInterfaceElementTemplate<DriverActivityAdmin>
		{
		public:
		...
		private:
			...
			//@{
				boost::shared_ptr<const DriverActivity>				_activity;
			//@}
		...
		public:
			...
			void setActivity(boost::shared_ptr<const DriverActivity> value){ _activity = value; }
		};
}	}

#endif // SYNTHESE_DriverActivityAdmin_H__
