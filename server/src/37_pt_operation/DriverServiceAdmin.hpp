...
//////////////////////////////////////////////////////////////////////////
/// DriverServiceAdmin class header.
///	@file DriverServiceAdmin.hpp
...
#ifndef SYNTHESE_DriverServiceAdmin_H__
#define SYNTHESE_DriverServiceAdmin_H__
...
namespace synthese
{
	namespace pt_operation
	{
		...
		//////////////////////////////////////////////////////////////////////////
		/// DriverServiceAdmin Admin compound class.
		///	@ingroup m37Admin refAdmin
		///	@author Hugues Romain
		///	@date 2011
		class DriverServiceAdmin:
			public admin::AdminInterfaceElementTemplate<DriverServiceAdmin>
		{
		public:
			static const std::string TAB_SERVICES;
			static const std::string TAB_CALENDAR;
			static const std::string TAB_DATASOURCE_LINKS;
		...
		private:
			...
			//@{
				boost::shared_ptr<const DriverService> _driverService;
			//@}
		...
		public:
			...
			void setDriverService(boost::shared_ptr<const DriverService> value){ _driverService = value; }
		};
	}
}

#endif // SYNTHESE_DriverServiceAdmin_H__
