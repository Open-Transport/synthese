...
/** MessageAlternativeTableSync class header.
	@file MessageAlternativeTableSync.hpp
...
#ifndef SYNTHESE_MessageAlternativeTableSync_H__
#define SYNTHESE_MessageAlternativeTableSync_H__
		...
		public:
			...
			*/
			static SearchResult Search(
				...
				boost::optional<util::RegistryKeyType> typeId = boost::optional<util::RegistryKeyType>(),
				int first = 0,
