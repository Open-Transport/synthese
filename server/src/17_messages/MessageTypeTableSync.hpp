...
/** MessageTypeTableSync class header.
	@file MessageTypeTableSync.hpp
...
#ifndef SYNTHESE_MessageTypeTableSync_H__
#define SYNTHESE_MessageTypeTableSync_H__
...
namespace synthese
{
	namespace messages
	{
		...
		/// @since 3.5.0
		//////////////////////////////////////////////////////////////////////////
		class MessageTypeTableSync:
			public db::DBDirectTableSyncTemplate<MessageTypeTableSync, MessageType>
		{
		public:
			/** Message type search.
