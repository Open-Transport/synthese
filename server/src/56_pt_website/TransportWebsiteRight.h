...
/** TransportWebsiteRight class header.
	@file TransportWebsiteRight.h
...
#ifndef SYNTHESE_transportwebsite_TransportWebsiteRight_H__
#define SYNTHESE_transportwebsite_TransportWebsiteRight_H__
	...
	namespace pt_website
	{
		/** TransportWebsiteRight Right Class.
			...
			Perimeter definition :
				-
		*/
		class TransportWebsiteRight : public security::RightTemplate<TransportWebsiteRight>
		{
		public:
...
#endif // SYNTHESE_transportwebsite_TransportWebsiteRight_H__
