...
public:
	OSMParserImpl(OSMEntityHandler& osmEntityHandler, 
...
OSMParserImpl::OSMParserImpl(OSMEntityHandler& osmEntityHandler, 
							 const std::string& cityCodeTag)
...
OSMParser::OSMParser(OSMEntityHandler& osmEntityHandler, const std::string& cityCodeTag)
: _pimpl(new OSMParserImpl(osmEntityHandler, cityCodeTag))
{
}
