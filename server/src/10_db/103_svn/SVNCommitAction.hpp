...
//////////////////////////////////////////////////////////////////////////
/// SVNCommitAction class header.
///	@file SVNCommitAction.hpp
...
#ifndef SYNTHESE_SVNCommitAction_H__
#define SYNTHESE_SVNCommitAction_H__
...
namespace synthese
{
	...
	namespace db
	{
		namespace svn
		{
			...
			///	</dl>
			class SVNCommitAction:
				public util::FactorableTemplate<server::Action, SVNCommitAction>
			{
			public:
...
#endif // SYNTHESE_SVNCommitAction_H__
