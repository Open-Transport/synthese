...
/** InheritanceLoadSavePolicy class header.
	@file InheritanceLoadSavePolicy.hpp
...
#ifndef SYNTHESE_db_InheritanceLoadSavePolicy_hpp__
#define SYNTHESE_db_InheritanceLoadSavePolicy_hpp__
...
namespace synthese
{
	...
	namespace db
	{
		...
		/** InheritanceLoadSavePolicy class.
			@ingroup m10
		*/
		template<
			class K,
			class T
		>
		class InheritanceLoadSavePolicy
		{
		public:
			InheritanceLoadSavePolicy() {}
		...
		template<class K, class T>
		boost::shared_ptr<T> InheritanceLoadSavePolicy<K, T>::GetNewObject()
		{
			return boost::shared_ptr<T>();
		}
}	}

#endif // SYNTHESE_db_InheritanceLoadSavePolicy_hpp__
