...
/** AccountRenameAction class header.
	@file AccountRenameAction.h
...
#ifndef SYNTHESE_AccountRenameAction_H__
#define SYNTHESE_AccountRenameAction_H__
...
#endif // SYNTHESE_AccountRenameAction_H__
