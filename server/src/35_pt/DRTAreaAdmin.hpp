...
#ifndef SYNTHESE_DRTAreaAdmin_H__
#define SYNTHESE_DRTAreaAdmin_H__
...
namespace synthese
{
	namespace pt
	{
		...
		public:
			...
			boost::shared_ptr<const DRTArea> getArea() const { return _area; }
		};
	}
}

#endif // SYNTHESE_DRTAreaAdmin_H__
