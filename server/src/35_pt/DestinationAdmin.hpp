...
//////////////////////////////////////////////////////////////////////////
/// DestinationAdmin class header.
///	@file DestinationAdmin.hpp
...
#ifndef SYNTHESE_DestinationAdmin_H__
#define SYNTHESE_DestinationAdmin_H__
...
namespace synthese
{
	namespace pt
	{
		...
		//////////////////////////////////////////////////////////////////////////
		/// DestinationAdmin Admin compound class.
		///	@ingroup m35Admin refAdmin
		///	@author Hugues Romain
		///	@date 2011
		class DestinationAdmin:
			public admin::AdminInterfaceElementTemplate<DestinationAdmin>
		{
		public:
		...
		private:
			...
			//@{
				boost::shared_ptr<const Destination> _destination;
			//@}
		...
		public:
			...
			void setDestination(boost::shared_ptr<const Destination> value){ _destination = value; }
		};
	}
}

#endif // SYNTHESE_DestinationAdmin_H__
