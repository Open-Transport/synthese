...
/** DatesListInterfaceElement class header.
	@file DatesListInterfaceElement.h
...
#ifndef SYNTHESE_DatesListInterfaceElement_H__
...
namespace synthese
{
	namespace routeplanner
	{
		...
		*/
		class DatesListInterfaceElement : public util::FactorableTemplate<interfaces::LibraryInterfaceElement,DatesListInterfaceElement>
		{
		...
		public:
			...
			*/
			...
			~DatesListInterfaceElement();
		};
	}
}

#endif // SYNTHESE_DatesListInterfaceElement_H__
