...
{
  $('#remove_title').html("d'abonné de liste de diffusion");
  $('#remove_name').html("l'abonné "+ $(this).attr('element_name'));
  $('#remove_form_tab_AUTOGENERATEDFIELDID').val('mailing_lists');
  $('#remove_form_open_subscriptions_AUTOGENERATEDFIELDID').val(1);
  $('#remove_form_actionParamoi_AUTOGENERATEDFIELDID').val($(this).attr('element_id'));
  $('#remove_modal').modal('show');
  return false;
}
