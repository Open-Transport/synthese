...
namespace synthese
{
	namespace graph
	{
		...
		public:
			...
			virtual ServicePointer getFromPresenceTime(bool RTData,bool getDeparture,std::size_t userClassRank,const Edge& edge, const boost::posix_time::ptime& presenceDateTime, bool controlIfTheServiceIsReachable, bool inverted, bool ignoreReservation, bool allowCanceled) const {return ServicePointer();}
