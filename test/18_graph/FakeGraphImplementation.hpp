...
namespace synthese
{
	namespace graph
	{
		...
		public:
			...
			virtual ServicePointer getFromPresenceTime(const synthese::graph::AccessParameters&, bool RTData,bool getDeparture, const Edge& edge, const boost::posix_time::ptime& presenceDateTime, bool controlIfTheServiceIsReachable, bool inverted, bool ignoreReservation, bool allowCanceled) const {return ServicePointer();}
