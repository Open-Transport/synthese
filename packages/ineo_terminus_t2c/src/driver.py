...
root = etree.Element("Driver" + type + "MessageRequest", attrib={locationAttribute: "http://schemas.open-transport.org/ineo-terminus/types-t2c.xsd"})
...
# 'Text' node accepts [1..3] line * [0..27] characters
