...
function select_template_and_submit()  // for double-click
{
  select_template_click.call($(this));
  $('form[name="scenario_add"]').submit();
}
...
$(function(){
  ...
  $(document).on('dblclick', '.template_element', select_template_and_submit);
