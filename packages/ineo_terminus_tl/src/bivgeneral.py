...
# DiodFlashing
if int(needs_light) != 0:
  childDiodFlashing = etree.SubElement(childMessaging, "DiodFlashing")
  childDiodFlashing.text = "oui" if int(message[0]["light"]) != 0 else "non"
...
# 'Text' node accepts [1..6] lines * [0..24] characters
lines = htmlParser.wrap_lines(6, 24)
for line in lines:
