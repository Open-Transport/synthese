...
MapBackgroundTile::draw (Map& map) const
{
    ...
    // cout << "Orig TopLeft = " << _topLeftX << ", " << _topLeftY << endl;
    // cout << "Outp TopLeft = " << tl.getX () << ", " << tl.getY () << endl;
   
       
   
    double translateX = tl.getX ();
    double translateY = br.getY () ; //map.getHeight () - tl.getY ();
//    double translateY = map.getHeight () - outputHeight - br.getY () ;
    
    
    // cout << "Translate X = " << translateX << endl;
     // cout << "Translate Y = " << translateY << endl;
