...
public:
    ...
    virtual bool Insert(const cTexte& __Table,cResultatBaseDeDonnees& __Valeurs,bool __Replace);
    virtual tIndex Update(const cTexte& __Table,const cTableauDynamique<cTexte>& __Champs,const cTableauDynamique<cTexte>& __Valeurs,const cTexte& __Where,tIndex __Limite);
