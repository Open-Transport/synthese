...
tIndex cInterface_Objet_Element_Goto::Evalue(ostream&, const cInterface_Objet_Connu_ListeParametres&, const void* ObjetAAfficher, const cSite* __Site) const
{
	return _NumeroLigne;
}
...
cInterface_Objet_Element_Goto::cInterface_Objet_Element_Goto(tIndex __NumeroLigne) : cInterface_Objet_Element()
{
