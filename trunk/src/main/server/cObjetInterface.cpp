...
{
	tIndex __LigneAAtteindre = INCONNU;
...
*/
const cInterface_Objet_Element* cInterface_Objet::_getElement(tIndex __Index) const
{
	if (__Index < 0)
		return NULL;
		
	const cInterface_Objet_Element* __EI = _PremierElement;
	for (tIndex __Compteur = 0; __Compteur < __Index; __Compteur++)
	{
...
const cInterface_Objet_Element_Parametre_TexteConnu* cInterface_Objet_AEvaluer::operator[](tIndex __Index) const
{
	return (cInterface_Objet_Element_Parametre_TexteConnu*) _getElement(__Index);
}

const cInterface_Objet_Element_Parametre* cInterface_Objet_Connu_ListeParametres::operator[](tIndex __Index) const
{
