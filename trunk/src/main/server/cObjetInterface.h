...
protected:
	...
	//!	\name Accesseurs
	//@{
	const cInterface_Objet_Element* _getElement(tIndex)													const;
	//@}
...
public:
	...
	//@{
	bool	EstVide()																					const;
	void	Evalue(ostream&, const cInterface_Objet_Connu_ListeParametres&, const void* __Objet=NULL
...
public:
	...
	//!	\name Accesseurs
	//@{
	const cInterface_Objet_Element_Parametre* operator[](tIndex)											const;
	//@}
...
public:
	...
	//!	\name Accesseurs
	//@{
	const cInterface_Objet_Element_Parametre_TexteConnu* operator[](tIndex)											const;
	//@}
