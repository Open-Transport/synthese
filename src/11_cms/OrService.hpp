...
#ifndef SYNTHESE_OrService_H__
#define SYNTHESE_OrService_H__
...
namespace synthese
{
	namespace cms
	{
		...
		/// @since 3.3.0
		class OrService:
			public util::FactorableTemplate<server::Function,OrService>
		{
		public:
