...
/**	CMSInstallRight class header.
	@file CMSInstallRight.hpp
...
#ifndef SYNTHESE_cms_CMSInstallRight_H__
#define SYNTHESE_cms_CMSInstallRight_H__
	...
	namespace cms
	{
		/** CMSInstallRight Right Class.
			...
			Perimeter definition :
				- 
		*/
		class CMSInstallRight : public security::RightTemplate<CMSInstallRight>
		{
		public:
...
#endif // SYNTHESE_cms_CMSInstallRight_H__
