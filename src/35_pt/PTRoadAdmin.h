...
#ifndef SYNTHESE_PTRoadAdmin_H__
#define SYNTHESE_PTRoadAdmin_H__
...
namespace synthese
{
	...
	{
		//////////////////////////////////////////////////////////////////////////
		/// PTRoadAdmin Admin compound class.
		///	@ingroup m35Admin refAdmin
		///	@author Hugues
		///	@date 2009
		class PTRoadAdmin:
			public admin::AdminInterfaceElementTemplate<PTRoadAdmin>
		{
		public:
			/// @name Parameter identifiers
			//@{
				static const std::string TAB_MAP;
				static const std::string TAB_DETAIL;
		...
		private:
			...
			//@{
				boost::shared_ptr<const road::Road>	_road;
		...
		public:
			...
			void setRoad(boost::shared_ptr<const road::Road> value);
...
#endif // SYNTHESE_PTRoadAdmin_H__
