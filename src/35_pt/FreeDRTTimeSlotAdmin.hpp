...
//////////////////////////////////////////////////////////////////////////
/// FreeDRTTimeSlotAdmin class header.
///	@file FreeDRTTimeSlotAdmin.hpp
...
#ifndef SYNTHESE_FreeDRTTimeSlotAdmin_H__
#define SYNTHESE_FreeDRTTimeSlotAdmin_H__
...
namespace synthese
{
	namespace pt
	{
		...
		//////////////////////////////////////////////////////////////////////////
		/// FreeDRTTimeSlotAdmin Admin compound class.
		///	@ingroup m35Admin refAdmin
		///	@author Hugues Romain
		///	@date 2011
		class FreeDRTTimeSlotAdmin:
		...
		private:
			...
			//@{
				boost::shared_ptr<const FreeDRTTimeSlot> _timeSlot;
			//@}
		...
		public:
			...
			void setTimeSlot(boost::shared_ptr<const FreeDRTTimeSlot> value){ _timeSlot = value; }
		};
}	}

#endif // SYNTHESE_FreeDRTTimeSlotAdmin_H__
