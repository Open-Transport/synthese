...
//////////////////////////////////////////////////////////////////////////
/// PhysicalStopUpdateAction class header.
///	@file PhysicalStopUpdateAction.h
...
namespace synthese
{
	namespace pt
	{
		...
		///	</ul>
		class PhysicalStopUpdateAction:
			public util::FactorableTemplate<server::Action, PhysicalStopUpdateAction>
		{
		public:
