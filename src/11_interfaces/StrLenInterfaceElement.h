...
/** StrLenInterfaceElement class header.
	@file StrLenInterfaceElement.h
	@author Hugues
	@date 2009
...
#ifndef SYNTHESE_StrLenInterfaceElement_H__
#define SYNTHESE_StrLenInterfaceElement_H__
...
namespace synthese
{
	...
	{
		/** StrLenInterfaceElement Library Interface Element Class.
			@author Hugues
			@date 2009
		...
		*/
		class StrLenInterfaceElement
			: public util::FactorableTemplate<interfaces::LibraryInterfaceElement, StrLenInterfaceElement>
		{
...
#endif // SYNTHESE_StrLenInterfaceElement_H__
