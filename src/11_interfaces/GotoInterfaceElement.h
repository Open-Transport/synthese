...
/** GotoInterfaceElement class header.
	@file GotoInterfaceElement.h
...
namespace synthese
{
	namespace interfaces
	{
		...
		*/
		class GotoInterfaceElement : public util::FactorableTemplate<LibraryInterfaceElement, GotoInterfaceElement>
		{
		private:
