			...
			switch(_category)
			{
				...
				case 1:	// login
					switch(_step)
					{
						...
						case 6: // ask key input
							return "veuillez entrer 7 pour consulter la liste des reservations effectu�es et 9 pour commencer une nouvelle recherche";
						...
						case 8: // close session
							return "L'entrée invalide, la session sera ferm�e. Merci de votre visite, au revoir.";
						default:
							return NULL;
					}
					break;
				...
				case 3:	// reservation
					switch(_step)
					{
						...
						case 2:	// favoris list
							return "Nous vous informons que votre reservation est effectuee avec succ�s.";
						case 3: // menukey 4,5,6,9,0
							return "5 pour �couter le trajet actuel, 4 pour precedent, 6 pour prochain. pressez 9 pour sortir.";
				...
				case 4:	// confirmation
					switch(_step)
					{
						case 1:	// how many resa
							return "Vous avez: ";
						case 2:	// add after 1
							return " reservation enregistr�e";
					}
