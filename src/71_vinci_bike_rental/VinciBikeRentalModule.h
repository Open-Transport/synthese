...
namespace synthese
{
	...
	namespace vinci
	{
		...
		private:
			...
			static boost::shared_ptr<VinciContract>			_vinciFreeRentContract;
		...
		public:
			...
			static const std::string VINCI_SERVICES_CODE_PREFIX;
			...
			static const std::string VINCI_STOCK_CODE_PREFIX;
			...
			*/			
			...
			//@{
				...
				*/
				...
				static boost::shared_ptr<const VinciContract>		GetFreeRentContract();
