// SYNTHESE integration note:
// On Debian, Boost doesn't have a pre-built library with random_device (see http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=261719)
// that's why we have to build it ourselves.
// This file was retrieved from Boost version 1.45.0.
