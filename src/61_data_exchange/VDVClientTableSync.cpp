...
namespace synthese
{
	...
	namespace db
	{
		...
		template<> void DBDirectTableSyncTemplate<VDVClientTableSync,VDVClient>::Load(
			VDVClient* website,
		...
		template<> void DBDirectTableSyncTemplate<VDVClientTableSync,VDVClient>::Unlink(
			VDVClient* obj
		){
			obj->unlink();
		}
		...
		template<> void DBDirectTableSyncTemplate<VDVClientTableSync,VDVClient>::Save(
			VDVClient* website,
			optional<DBTransaction&> transaction
		){
			// Query
			ReplaceQuery<VDVClientTableSync> query(*website);
