...
//////////////////////////////////////////////////////////////////////////
///	TrafficForecastTableSync class header.
///	@file TrafficForecastTableSync.hpp
///	@author hromain
///	@date 2013
///
...
#ifndef SYNTHESE_TrafficForecastTableSync_hpp__
#define SYNTHESE_TrafficForecastTableSync_hpp__
...
namespace synthese
{
	...
	{
		//////////////////////////////////////////////////////////////////////////
		///	TrafficForecast table synchronizer.
		///	@ingroup m60LS refLS
		///	@author hromain
		///	@date 2013
		/// @since 3.9.0
		class TrafficForecastTableSync:
			public db::DBDirectTableSyncTemplate<TrafficForecastTableSync,TrafficForecast>
		{
		public:
			//! @name Services
			//@{		
				//////////////////////////////////////////////////////////////////////////
				///	TrafficForecast search.
...
#endif // SYNTHESE_TrafficForecastTableSync_hpp__
