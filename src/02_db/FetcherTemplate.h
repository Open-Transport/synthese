		...
		*/
		...
		protected:
			virtual boost::shared_ptr<BaseClass> _getEditable(
				...
				return static_pointer_cast<BaseClass, TableSync::ObjectType>(TableSync::GetEditable(key, env, linkLevel, autoCreate));
			}
			...
			virtual boost::shared_ptr<const BaseClass> _get(
				...
				return static_pointer_cast<const BaseClass, const TableSync::ObjectType>(TableSync::Get(key, env, linkLevel, autoCreate));
			}
		};
	}
}
