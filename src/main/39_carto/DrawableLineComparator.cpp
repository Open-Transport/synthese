...
DrawableLineComparator::calculateStartAngles (const std::vector<const Point*>& points1, int index1,
					      const std::vector<const Point*>& points2, int index2) const
{
...
std::pair<double, double>
DrawableLineComparator::calculateEndAngles (const std::vector<const Point*>& points1, int index1,
					    const std::vector<const Point*>& points2, int index2) const
{
    assert (points1.size () >= 2);
    assert (points2.size () >= 2);
