...
#define SYNTHESE_INTERFACE_MODULE_H
...
namespace synthese
{
	...
	/** @defgroup m11 11 Interface
		...
		Each page compound is used in the page definition using a text code, which is stored staticaly in each corresponding class. 		When a command needs precision to specify the subclass to use or then index of the parameter, then the code follows the command.
	...
	*/
	...
	/** 11_service namespace */
	namespace interface
	{

		static std::string INTERFACE_PAGE_ADMIN("admin");
