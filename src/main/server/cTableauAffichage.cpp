...
bool cTableauAffichage::SetNombreDeparts( int __NombreDeparts )
{
...
void cTableauAffichage::AddArretPhysiqueAutorise( int __NumeroArretPhysique )
{
...
cDescriptionPassage* cTableauAffichage::Calcule( const synthese::time::DateTime& __MomentDebut ) const
{
    // Variables
    synthese::time::DateTime __MomentFin = _MomentFin( __MomentDebut );
    int iNumeroService;
...
synthese::time::DateTime cTableauAffichage::_MomentFin( const synthese::time::DateTime& __MomentDebut ) const
{
    synthese::time::DateTime __MomentFin = __MomentDebut;
    if ( _HeureBascule.isUnknown () )
        __MomentFin.addDaysDuration();
    else
    {
        if ( __MomentFin.getHour() >= _HeureBascule )
            __MomentFin.addDaysDuration();
        __MomentFin.setHour( _HeureBascule );
    }
...
*/
void cTableauAffichage::SetNumeroPanneau( int __NumeroPanneau )
{
...
*/
int cTableauAffichage::getNumeroPanneau() const
{
