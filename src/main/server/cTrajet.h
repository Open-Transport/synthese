...
class cTrajet
{
    private:
        ...
        int _Duree;      //!< Dur�e totale du trajet
        int _DureeRoulee;    //!< Temps pass� dans les transports
        int _AmplitudeServiceContinu; //!< Amplitude de desserte si service continu
    ...
    public:
        ...
        int Taille() const;
        int getAmplitudeServiceContinu() const;
        //@}
        ...
        void setAmplitudeServiceContinu( const int& );
...
inline const int& cTrajet::getDuree() const
{
    return _Duree;
}


inline const int& cTrajet::getDureeRoulee() const
{
    return _DureeRoulee;
}
