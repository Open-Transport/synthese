...
class cEnvironnement
{
    ...
    private:
        ...
        //! \name Parametres
        //@{
        int vPremiereAnnee;  //!< Premi�re ann�e des calendriers de circulation en m�moire
        int vDerniereAnnee;  //!< Derni�re ann�e des calendriers de circulation en m�moire
        const size_t Code;    //!< Code de l'environnement
        //@}

        //! \name Variables d'analyse
        //@{
        synthese::time::Date vDateMin;   //!< Premier jour de circulation effective dans la base de donn�es
        synthese::time::Date vDateMax;   //!< Dernier jour de circulation effective dans la base de donn�es
        //@}
    ...
    public:
        ...
        synthese::time::Date DateMaxPossible() const;
        synthese::time::Date DateMinPossible() const;
        const synthese::time::Date& DateMaxReelle() const;
        const synthese::time::Date& DateMinReelle() const;
        int DerniereAnnee() const;
