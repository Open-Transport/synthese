...
/*!	\brief Modificateur libellé jour de semaine
	...
	\date 2005
*/
 bool cInterface::SetLibelleJour(tIndex __Index, const cTexte& __Libelle)
{
...
/*!	\brief Modificateur libellé mois
	...
	\date 2005
*/
 bool cInterface::SetLibelleMois(tIndex __Index, const cTexte& __Libelle)
{
...
/*!	\brief Accesseur libellé de jour de la semaine
	...
	\date 2005
*//*
 const cTexte& cInterface::LibelleJourSemaine(tIndex __Index) const
{
