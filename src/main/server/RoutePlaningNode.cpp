        ...
        : _logicalPlace( accessPoint->getLogicalPlace() )
{
    if ( accessPoint->getLogicalPlace() ->CorrespondanceAutorisee() != LogicalPlace::CorrInterdite )
    {
        ...
        for ( LogicalPlace::PhysicalStopsMap::const_iterator iter = physicalStops.begin();
                ...
                ++iter )
        {
            int transferDuration = _logicalPlace->AttenteCorrespondance( forDeparture ? accessPoint->getRankInLogicalPlace() : iter->second->getRankInLogicalPlace()
                ...
                iter != adresses.end (); ++iter )
        {
            ...
            for ( std::set
                        ...
                        ++distanceAndAddress )
                {
                    ...
                    int approachDuration = approachDistance / approachSpeed; // seconds
...
*/
void RoutePlanningNode::addAccessPoint( const cArretPhysique* const accessPoint, const int& approachDuration, const DistanceInMeters& approachDistance )
{
