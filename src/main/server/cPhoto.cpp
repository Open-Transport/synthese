...
/*! \brief Ajout d'une zone cliquable liant une autre photo
	...
	\date 2002
*/
bool cPhoto::addMapPhoto(const cTexte& newCoords, tIndex newLienPhoto, const cTexteHTML& newAlt)
{
...
tIndex cPhoto::NombreMaps() const
{
	return _Map.Taille();
}
...
// 
// ____________________________________________________________________________ 
const cMapPhoto& cPhoto::Map(tIndex i) const
{
	return _Map[i];
}
// © Hugues Romain 2003
...
const tIndex cMapPhoto::LienPhoto()	const
{
	return(vLienPhoto);
}
