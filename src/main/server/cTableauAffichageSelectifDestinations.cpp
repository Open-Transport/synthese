...
cTableauAffichageSelectifDestinations::cTableauAffichageSelectifDestinations( const std::string& __Code )
...
cDescriptionPassage* cTableauAffichageSelectifDestinations::Calcule( const synthese::time::DateTime& __MomentDebut )
{
    return NULL;
}
