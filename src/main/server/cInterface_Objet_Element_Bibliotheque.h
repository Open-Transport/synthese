...
{
	tIndex										_Index;		//!< Index de l'objet dynamique qui sera �valu� (Voir parametres.h)
...
public:
	...
	//!	\name Constructeurs
	//@{
	explicit cInterface_Objet_Element_Bibliotheque(tIndex);
	explicit cInterface_Objet_Element_Bibliotheque(tIndex, const cTexte&);
	//@}
};
