...
namespace synthese
{
	...
	namespace vinci
	{
		...
		AdminInterfaceElement::PageLinks VinciSiteAdmin::getSubPagesOfParent( const PageLink& parentLink , const AdminInterfaceElement& currentPage		, const server::FunctionRequest<admin::AdminRequest>* request
			) const
		{
