...
#ifndef SYNTHESE_vinci_VinciRight_H__
#define SYNTHESE_vinci_VinciRight_H__
...
namespace synthese
{
	namespace vinci
	{
		/** VinciRight Right Class.
			@ingroup m71Rights refRights
			...
			Perimeter definition :
				- 
		*/
		class VinciRight : public security::RightTemplate<VinciRight>
		{
		public:
...
#endif // SYNTHESE_vinci_VinciRight_H__
