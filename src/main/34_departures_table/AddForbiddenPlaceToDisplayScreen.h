...
/** AddForbiddenPlaceToDisplayScreen class header.
	@file AddForbiddenPlaceToDisplayScreen.h
...
namespace synthese
{
	...
	namespace departurestable
	{
		...
		/** AddForbiddenPlaceToDisplayScreen action class.
			@ingroup m34
		*/
		class AddForbiddenPlaceToDisplayScreen : public server::Action
		{
		public:
		...
		public:
			/** Constructor.
			*/
			AddForbiddenPlaceToDisplayScreen();
