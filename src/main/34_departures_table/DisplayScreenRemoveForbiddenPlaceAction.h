...
/** DisplayScreenRemoveForbiddenPlaceAction class header.
@file DisplayScreenRemoveForbiddenPlaceAction.h
	...
	namespace departurestable
	{
		...
		*/
		...
		public:
			/** Constructor.
			*/
			DisplayScreenRemoveForbiddenPlaceAction();
...
#endif // SYNTHESE_DisplayScreenRemoveForbiddenPlaceAction_H__
