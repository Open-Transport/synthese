...
namespace synthese
{
	...
	namespace db
	{
		...
		template<>
		void SQLiteInheritedTableSyncTemplate<AlarmTableSync,SingleSentAlarmInheritedTableSync,SingleSentAlarm>::_Link(SingleSentAlarm* obj, const SQLiteResultSPtr& rows, GetSource temporary)
		{
		}

		template<>
		void SQLiteInheritedTableSyncTemplate<AlarmTableSync,SingleSentAlarmInheritedTableSync,SingleSentAlarm>::_Unlink(SingleSentAlarm* obj)
		{
		}
	}
