...
/** BikeComplyer class implementation.
	@file BikeComplyer.cpp
...
BikeComplyer::BikeComplyer (const BikeComplyer* parent, 
			    const BikeCompliance* bikeCompliance)
    : _parent (parent)
...
void 
BikeComplyer::setBikeCompliance (const BikeCompliance* bikeCompliance)
{
    _bikeCompliance = bikeCompliance;
}
