...
: ComponentTableSync (CONNECTIONPLACES_TABLE_NAME, true, false, db::TRIGGERS_ENABLED_CLAUSE)
{
    ...
    addTableColumn (CONNECTIONPLACES_TABLE_COL_ISCITYMAINCONNECTION, "BOOLEAN", false);
