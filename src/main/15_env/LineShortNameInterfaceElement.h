...
/** LineShortNameInterfaceElement class header.
	@file LineShortNameInterfaceElement.h
...
#ifndef SYNTHESE_LineShortNameInterfaceElement_H__
#define SYNTHESE_LineShortNameInterfaceElement_H__
