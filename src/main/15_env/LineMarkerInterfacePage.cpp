...
namespace synthese
{
	...
	namespace env
	{
		void LineMarkerInterfacePage::display( std::ostream& stream, const std::string& tableOpeningHTML , const std::string& tableClosingHTML , int pixelWidth , int pixelHeight , const synthese::env::Line* line , const server::Request* request /*= NULL */ ) const
		{
			ParametersVector pv;
