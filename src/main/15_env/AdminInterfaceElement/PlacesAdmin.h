		...
		/** Ecran de recherche de lieux pour administration.
			...
			<i>Zone de contenu</i> :
				-# <b>Formulaire de recherche</b>
					...
					-# <tt>Terminaux d'affichage</tt> : Liste déroulante permettant de sélectionner l'affichage des seuls emplacements disposant d'au moins un afficheur installé.
			...
			<i>Sécurité</i>
				- Une habilitation de niveau lecture sur le module environnement et sur l'opération emplacements est nécessaire pour afficher la page. Le périmètre de l'habilitation restreint éventuellement le résultat des recherches.
