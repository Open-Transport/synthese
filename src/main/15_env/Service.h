		...
		*/
		...
		public:
			...
			*/
			...
			virtual time::Schedule getDepartureBeginScheduleToIndex(const Edge* edge) const = 0;
			virtual time::Schedule getDepartureEndScheduleToIndex(const Edge* edge) const = 0;
