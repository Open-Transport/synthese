...
namespace synthese
{
	...
	namespace util
	{
		template<> const std::string FactorableTemplate<LibraryInterfaceElement, LineStyleInterfaceElement>::FACTORY_KEY = "line_style";
	}

	namespace env
	{
		string LineStyleInterfaceElement::display(
			ostream& stream
