...
int cFormatFichier::GetNombre(const cTexte& Texte, tIndex n, int NumeroColonne) const
{
...
/*!	\brief Extraction du texte d'une ligne de fichier en fonction du format
	...
	\date 2000-2005
*/
cTexte cFormatFichier::Extrait(const cTexte& __Texte, tIndex __n, int __NumeroColonne) const
{
	cTexte __Retour;
...
cTexte cFormatFichier::ExtraitComplet(const cTexte& Texte, tIndex n) const
{
	return(Texte.Extrait(vColonnePosition[n]));
}

int cFormatFichier::GetColonneLargeur(tIndex n) const
{
	return(vColonneLongueur[n]);
}

int cFormatFichier::GetColonnePosition(tIndex n, int NumeroColonne) const
{
...
*/
int cFormatFichier::Longueur(const cTexte& Texte, tIndex n) const
{
