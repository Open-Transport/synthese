...
/*
    ...
    cout << "tile width  = " << _tileWidth << endl;    
    cout << "tile height = " << _tileHeight << endl;    
    */
    
    _numTilesX = (int) ceil((_maxX - _minX) / _tileWidth);
    _numTilesY = (int) ceil((_maxY - _minY) / _tileHeight);

    // cout << "num tiles x" << _numTilesX  << endl;
    // cout << "num tiles y" << _numTilesY  << endl;
...
//        assert (_tileArray[tileIndexX][_numTilesY - tileIndexY - 1] == 0);
        _tileArray[tileIndexX][tileIndexY] = tile;
    }        
    
    
/*    cout << "total width" <<  (maxX - minX)  << endl;
    cout << "num tiles x" << _numTilesX  << endl;
    cout << "num tiles y" << _numTilesY  << endl; */
    
     cout << tiles.size () << " tiles found!" << endl;
