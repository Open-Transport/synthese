...
namespace synthese
{
	namespace impex
	{
		...
		{
			return _codeBySource;
		}

		const DataSource* Importable::getDataSource() const
		{
			return _dataSource;
		}

		void Importable::setCodeBySource( const std::string& value )
		{
			_codeBySource = value;
		}

		void Importable::setDataSource( const DataSource* value )
		{
			_dataSource = value;
		}
	}
