...
/** DeparturesTableLineContentInterfaceElement class header.
	@file DeparturesTableLineContentInterfaceElement.h
...
#endif // SYNTHESE_DeparturesTableLineContentInterfaceElement_H__
