...
/** MailingListTableSync class header.
	@file MailingListTableSync.hpp
...
#ifndef SYNTHESE_MailingListTableSync_H__
#define SYNTHESE_MailingListTableSync_H__
...
namespace synthese
{
	namespace messages
	{
		...
		/// @since 3.7.0
		//////////////////////////////////////////////////////////////////////////
		class MailingListTableSync:
			public db::DBDirectTableSyncTemplate<MailingListTableSync, MailingList>
		{
		public:
			/** Message type search.
