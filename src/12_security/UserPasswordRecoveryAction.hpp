...
/** UserPasswordRecoveryAction class header.
	@file UserPasswordRecoveryAction.hpp
	@date 2013
...
#ifndef SYNTHESE_UserPasswordRecoveryAction_H__
#define SYNTHESE_UserPasswordRecoveryAction_H__
...
namespace synthese
{
	...
	namespace security
	{
		 ...
		 */
		class UserPasswordRecoveryAction:
			public util::FactorableTemplate<server::Action, UserPasswordRecoveryAction>
		{
		public:
			static const std::string PARAMETER_LOGIN;
			static const std::string PARAMETER_MAIL;
		...
		private:
			std::string _login;
			std::string _mail;
			boost::shared_ptr<const cms::Webpage> _cmsPasswordRecoveryEMail;
		...
		public:
			...
			void setPasswordRecoveryEMailCMS(boost::shared_ptr<const cms::Webpage> cms);
			 ...
			 *	@date 2013
			 */
			bool sendPasswordRecoveryEMail(const security::User& user, const std::string senderEMail, const std::string senderName) const;
...
#endif // SYNTHESE_UserPasswordRecoveryAction_H__
