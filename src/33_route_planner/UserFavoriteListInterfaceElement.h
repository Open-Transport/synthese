...
/** UserFavoriteListInterfaceElement class header.
	@file UserFavoriteListInterfaceElement.h
...
namespace synthese
{
	namespace routeplanner
	{
		/** UserFavoriteListInterfaceElement Library Interface Element Class.
			...
			Parameters :
				- 0 : code of the page to use to display each favorite journey
			
		*/
		class UserFavoriteListInterfaceElement
			: public util::FactorableTemplate<interfaces::LibraryInterfaceElement, UserFavoriteListInterfaceElement>
		{
			// List of parameters to store
			boost::shared_ptr<interfaces::LibraryInterfaceElement> _elementPageCode;
		...
		public:
			...
			*/
			...
			~UserFavoriteListInterfaceElement();
		};
	}
}

#endif // SYNTHESE_UserFavoriteListInterfaceElement_H__
