...
namespace synthese
{
	...
	namespace routeplanner
	{
		...
		///		<li>connection : transfert à pied d’un arrêt vers un autre différent, sans pour autant fournir le descriptif du trajet à emprunter</li></ul>
		///
		...
		///
		///	Un section utilisant une ligne de transport public (JourneyTransportType) est décrite comme suit :
		///
