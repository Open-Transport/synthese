		...
		*/
		...
		public:
			...
			*/
			...
			typedef std::vector<boost::shared_ptr<graph::Journey> >	Journeys;
		...
		private:
			...
			*/
			...
			/** Control of la compatibilit̩ entre l'ordre des arr̻ts dans la grille horaire et les arr̻ts du trajet.
			*/
			...
			*/
			...
			const bool		_samePlaces;	//!< Indicates if the route planning was attempted between to identical places (in this case : empty result)
			const Journeys	_journeys;		//!< List of the result journeys, ordered by departure time
		...
		public:
			...
			*/
			PTRoutePlannerResult(
				...
				bool samePlaces,
				const RoutePlanner::Result& journeys
			);
