...
namespace synthese
{
	...
	namespace pt_journey_planner
	{
		...
		/// <h4>paramètres d'affichage (sortie XML uniquement)</h4>
		///		<ul>
		///		<li>[showResTab=yes/no] : "yes" par défaut : choix d'afficher ou non la balise ResultTable</li>
		///		<li>[showCoords=yes/no] : "yes" par défaut : choix d'afficher ou non les attributs de coordonnées</li>
		///		</ul>
		/// <h3>Response</h3>
		///
		///		<ul>
		...
		///			<li>deadLine : indique la date et l'heure limite de réservation. Au-delé de cette limite, la réservation devient impossible. Si elle est obligatoire, alors l'itinéraire n'est plus utilisable. Si elle est facultative, alors l'itinéraire reste utilisable mais n'est plus ouvert à la réservation des places</li>
		...
		///		<li>length : longueur du tronçon en mêtres</li>
		...
		///		<li>startStop : arrêt physique de départ (type PhysicalStopType à voir plus bas)</li>
		///		<li>endStop : arrêt physique d'arrivée (type PhysicalStopType à voir plus bas)</li>
		...
		///			<li>cssClass (optionnel) : classe CSS définissant le graphisme du numéro de ligne dans un cartouche (couleur de fond, couleur de texte, style de caractéres, etc.). Correspond en général à la représentation officielle de la ligne sur les divers supports</li>
		...
		///			<li>alert (optionnel) : message d'alerte en cours de validité sur la ligne au moment du trajet (type AlertType à voir plus bas)</li></ul>
		...
		///		<li>name (optionnel) : nom de l'arrêt permettant de le distinguer par rapport aux autres arrêts de la méme zone d'arrêts (ex : quai 12)</li>
		///		<li>connectionPlace : zone d'arrêt (ConnectionPlaceType à voir plus loin) à laquelle appartient l'arrêt</li>
		///	</ul>
		///
		...
		///		<li>endArrivalTime (optionnel, si service continu uniquement) : fin  de la plage horaire de desserte à l'arrivée du tronçon</li>
		///		<li>length : longueur du tronçon en mêtres</li>
		///		<li>startStop : arrêt physique de départ (type PhysicalStopType à voir plus haut)</li>
		///		<li>endStop : arrêt physique d'arrivée (type PhysicalStopType à voir plus haut)</li>
		///	</ul>
		///
		...
		///		<li>place : lieu correspondant à la ligne du tableau (type PlaceType à voir plus bas)</li>
		...
		///				<li>traversal : indique qu'un trajet piéton a démarré avant cette cellule et se terminera aprés cette cellule (dans le sens de lecture de la colonne). Un pictogramme peut l'indiquer si souhaité.</li>
		///			</ul>
		/// </ul></ul>
		///
		...
		///			<li>alert : message d'alerte valable dans au moins une des solutions utilisant la zone d'arrêt (type AlertType à voir plus bas)</li>
		///		</ul>
		...
		///			<li>id : identificateur du lieu public dans la base de données de SYNTHESE (pérenne)</li>
		///			<li>city : nom de la ville à laquelle appartient le lieu public</li>
		///			<li>number : numéro de l'habitation. Optionnel : si non présent, l'objet représente la rue entiére</li>
