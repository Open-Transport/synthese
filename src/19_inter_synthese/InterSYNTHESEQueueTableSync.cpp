...
namespace synthese
{
	...
	namespace db
	{
		...
		template<> void DBDirectTableSyncTemplate<InterSYNTHESEQueueTableSync,InterSYNTHESEQueue>::Load(
			InterSYNTHESEQueue* website,
		...
		template<> void DBDirectTableSyncTemplate<InterSYNTHESEQueueTableSync,InterSYNTHESEQueue>::Unlink(
		...
		template<> void DBDirectTableSyncTemplate<InterSYNTHESEQueueTableSync,InterSYNTHESEQueue>::Save(
			InterSYNTHESEQueue* website,
			optional<DBTransaction&> transaction
		){
			// Query
			ReplaceQuery<InterSYNTHESEQueueTableSync> query(*website);
