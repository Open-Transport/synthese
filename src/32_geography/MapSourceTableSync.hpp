...
//////////////////////////////////////////////////////////////////////////
///	MapSourceTableSync class header.
///	@file MapSourceTableSync.hpp
///	@author RCSobility
///	@date 2011
///
...
#ifndef SYNTHESE_MapSourceTableSync_hpp__
#define SYNTHESE_MapSourceTableSync_hpp__
...
namespace synthese
{
	...
	{
		//////////////////////////////////////////////////////////////////////////
		///	MapSource table synchronizer.
		///	@ingroup m32LS refLS
		///	@author Hugues Romain
		///	@date 2011
		/// @since 3.3.0
		class MapSourceTableSync:
			public db::DBRegistryTableSyncTemplate<MapSourceTableSync,MapSource>
		{
		public:
			//! @name Field names
			//@{
...
#endif // SYNTHESE_MapSourceTableSync_hpp__
