...
//////////////////////////////////////////////////////////////////////////
/// MapSourceAdmin class header.
///	@file MapSourceAdmin.hpp
...
#ifndef SYNTHESE_MapSourceAdmin_H__
#define SYNTHESE_MapSourceAdmin_H__
...
namespace synthese
{
	namespace geography
	{
		...
		//////////////////////////////////////////////////////////////////////////
		/// MapSourceAdmin Admin compound class.
		///	@ingroup m35Admin refAdmin
		///	@author Hugues Romain
		///	@date 2011
		class MapSourceAdmin:
			public admin::AdminInterfaceElementTemplate<MapSourceAdmin>
		{
		public:
		...
		private:
			...
			//@{
				boost::shared_ptr<const MapSource> _mapSource;
			//@}
		...
		public:
			...
			void setMapSource(boost::shared_ptr<const MapSource> value){ _mapSource = value; }
		};
	}
}

#endif // SYNTHESE_MapSourceAdmin_H__
