...
/** WebsiteUpdateAction class header.
	@file WebsiteUpdateAction.h
...
#ifndef SYNTHESE_WebsiteUpdateAction_H__
#define SYNTHESE_WebsiteUpdateAction_H__
...
namespace synthese
{
	...
	namespace cms
	{
		...
		///	</ul>
		class WebsiteUpdateAction
			: public util::FactorableTemplate<server::Action, WebsiteUpdateAction>
		{
		public:
...
#endif // SYNTHESE_WebsiteUpdateAction_H__
